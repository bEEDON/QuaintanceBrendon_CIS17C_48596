   ...
   char choice='A';
	cout<<"\n\n__________________________________ MAIN MENU ___________________________________\n\n";
		...
		if(choice == '3'){
			char back;
			system("CLS");
			cout<<"\n\n_________________________________ DAMAGE TREE __________________________________\n";
			cout<<" -Displaying the Tree that consists of all damage done to the enemy."<<endl<<endl;
...
void hashDisplay(char hero,int&speech){
	char answer;
			system("CLS");
			cout<<"\n\n_________________________________ DAMAGE HASH __________________________________\n";
